...
export function Onboarding({ onConnected, telegramUser }: OnboardingProps) {
  ...
  try {
    ...
    // Disconnect stale session first, then open fresh modal
    ...
    <div className="min-h-screen flex flex-col bg-[#080E1C] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(21,101,255,0.15) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute bottom-[-10%] right-[-20%] w-[400px] h-[400px] rounded-full blur-[100px]"
          style={{
            background:
              "radial-gradient(circle, rgba(0,152,234,0.1) 0%, transparent 70%)",
          }}
        />
        <div
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 relative z-10 gap-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 60px rgba(21,101,255,0.5), 0 0 120px rgba(21,101,255,0.2)",
              }}
            >
          ...
          <div className="text-center">
            {telegramUser && (
              <p className="text-sm text-[#5A6B82] mb-2">
            ...
            <p className="text-[#5A6B82] text-base mt-3 leading-relaxed">
              Cross-chain swaps · AI advisor · Live portfolio
              <br />
          ...
          {[
            {
              ...
              desc: "Best rates via Omniston across 5 chains",
            },
            {
              icon: "🤖",
              title: "Mira AI Advisor",
              desc: "Ask anything about your portfolio",
            },
            {
              icon: "📊",
              title: "Live Portfolio",
              desc: "Real-time balances from your wallet",
            },
          ].map(({ icon, title, desc }) => (
            <div
              key={title}
              className="flex items-center gap-3.5 bg-[#0D1829] rounded-2xl p-4 border border-white/[0.05]"
            >
      ...
      <div className="px-6 pb-12 pt-4 relative z-10 flex flex-col gap-3">
        ...
        <button
          ...
          style={{
            background: "linear-gradient(135deg, #1565FF, #0098EA)",
            boxShadow: "0 8px 32px rgba(21,101,255,0.4)",
          }}
        >
        ...
        <p className="text-center text-xs text-[#3A4B5C]">
          Powered by <span className="text-[#8A9BB5]">STON.fi Omniston</span> ·{" "}
          <span className="text-[#8A9BB5]">TON</span>
        </p>
      </div>
    </div>
  );
